...
**v3 of this package is compatible with Umbraco v9**, please change to the [develop-v3](https://github.com/CrumpledDog/Umbraco-HealthCheckSlackNotificationMethod/tree/develop-v3) branch
