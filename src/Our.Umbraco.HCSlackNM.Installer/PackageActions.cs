        ...
        public class TransformConfig : IPackageAction
        {
            ...
            public XmlNode SampleXml()
            {
                string xml = "<Action runat=\"install\" "
                          + "undo=\"true\" alias=\"HealthCheckSlackNotificationMethod.TransformConfig\" "
                          + "file=\"~/web.config\" xdtfile=\"~/app_plugins/HealthCheckSlackNotificationMethod/install/HealthChecks.config\">"
                          + "</Action>";
            ...
            /// <returns><c>true</c> if the transform is successful.</returns>
            private bool Transform(string packageName, XElement xmlData, bool uninstall = false)
            {
                ...
                if (xmlData.Attributes() != null)
                {
                    ...
                    // The xdt file used for transformation
